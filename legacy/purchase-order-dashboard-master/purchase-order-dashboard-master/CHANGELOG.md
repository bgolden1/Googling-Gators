...
- refactor(AdminDashboard): tweak lazy and Suspense for Widget03 
...
- feat(AdminDashboard): new `Suspense` example with Widget03
...
- refactor: AdminDashboard legend badge pill
...
###### `v1.0.8`
- refactor: AdminDashboard radio buttons, new `onRadioBtnClick()` method
...
- AdminDashboard .dropdown-menu-right temp.scss hotfix (full)
- callout.scss .chart-wrapper hotfix (full)

###### `2017.08.11`
- Bootstrap 4 beta
- AdminDashboard component (full):
